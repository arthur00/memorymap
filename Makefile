...
DATA = $(dist_noinst_DATA) $(pkgconfig_DATA) $(pkglib_DATA)
...
ACLOCAL = ${SHELL} /Users/chrisdimpfl/valgrind/missing --run aclocal-1.11
AMTAR = ${SHELL} /Users/chrisdimpfl/valgrind/missing --run tar
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /Users/chrisdimpfl/valgrind/missing --run autoconf
AUTOHEADER = ${SHELL} /Users/chrisdimpfl/valgrind/missing --run autoheader
AUTOMAKE = ${SHELL} /Users/chrisdimpfl/valgrind/missing --run automake-1.11
AWK = gawk
BOOST_CFLAGS = 
BOOST_LIBS = 
CC = gcc
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEFAULT_SUPP = exp-sgcheck.supp xfree-3.supp xfree-4.supp darwin10-drd.supp darwin10.supp 
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DIFF = diff -u
ECHO_C = \c
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /Users/chrisdimpfl/valgrind/missing --run makeinfo
...
abs_builddir = /Users/chrisdimpfl/valgrind
abs_srcdir = /Users/chrisdimpfl/valgrind
abs_top_builddir = /Users/chrisdimpfl/valgrind
abs_top_srcdir = /Users/chrisdimpfl/valgrind
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /Users/chrisdimpfl/valgrind/install-sh
...
DEFAULT_SUPP_FILES = exp-sgcheck.supp xfree-3.supp xfree-4.supp darwin10-drd.supp darwin10.supp 
...
installdirs-am:
	for dir in "$(DESTDIR)$(pkgconfigdir)" "$(DESTDIR)$(pkglibdir)"; do \
...
uninstall-am: uninstall-pkgconfigDATA uninstall-pkglibDATA
...
regtest: check
	...
	/opt/local/bin/perl tests/vg_regtest gdbserver_tests $(TEST_TOOLS) $(TEST_EXP_TOOLS)
nonexp-regtest: check
	/opt/local/bin/perl tests/vg_regtest $(TEST_TOOLS)
exp-regtest: check
	/opt/local/bin/perl tests/vg_regtest gdbserver_tests $(TEST_EXP_TOOLS)
...
perf: check
	/opt/local/bin/perl perf/vg_perf perf
